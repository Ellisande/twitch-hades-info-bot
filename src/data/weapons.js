const staff = {
  attack:
    "Three hit melee combo. 20, 25, 30 damage. Omega: Line attack that deals 120 damage, uses 20 mana",
  special:
    "Shoots a projectile that slowly tracks, deals 10 damage. Omega: Shoots a ball of energy that deals 80 damage, uses 10 mana",
...
const daggers = {
  attack:
    "Four hit melee combo. 20, 20, 50, 80 damage. Omega: Dash to the target dealing 100 damage, uses 10 mana",
  special:
    "Throw a fast dagger which deals 25 damage. Omega: Throw 5 daggers in an arc, each dealing 25 damage, uses 15 mana",
...
const axe = {
  attack:
    "Slow three hit melee combo. 40, 80, 160 damage. Omega: Spin hitting multiple times for 50 damage per hit. Uses up to 20 mana. Disorients you temporarily on completion.",
  special:
    "Spin your axe creating a shield and dealing 10 damage to enemies. Omega: Send waves forward in wide areas dealing 140 damage, uses 25 mana",
  info: "Zorephet was to be a labrys so broad as could conceal the Moon herself. [attack] [special]",
};

const torch = {
  attack:
    "Deal 15 damage with piercing projectiles. Omega: Holding fire eventually ramps to doing 50 damage per projectile at 5 mana per hit",
  special:
